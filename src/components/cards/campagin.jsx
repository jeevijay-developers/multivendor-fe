...
// mui
import { Typography, Card, Box, Stack, CardContent, alpha, Skeleton, CardActionArea } from '@mui/material';
// components
...
export default function CampaignCard({ campaign, isLoading }) {
  return (
    ...
    >
      <CardActionArea component={Link} href={'/campaigns/' + campaign?.slug}>
        <Box
          sx={{
            position: 'relative',
            overflow: 'hidden',
